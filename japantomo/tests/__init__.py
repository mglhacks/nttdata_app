...
from japantomo import create_app
from japantomo.user import User, UserDetail, ADMIN, USER, ACTIVE
from japantomo.config import TestConfig
from japantomo.extensions import db
from japantomo.utils import MALE
